    ...
    BackgroundImage {
        ...
        TexturePackerAnimatedSprite {
            ...
            MouseArea {
                ...
                {
                    if(flag == 1){
                        sprite17.anchors.bottomMargin = sprite17.anchors.bottomMargin+20;
                        flag = 0;
                    }else if(flag == 0)
                    {
                        sprite17.anchors.bottomMargin = sprite17.anchors.bottomMargin-20;
        ...
        TexturePackerAnimatedSprite {
            ...
            MouseArea {
                ...
                {
                    if(flag == 1){
                        sprite18.anchors.bottomMargin = sprite18.anchors.bottomMargin+20;
                        flag = 0;
                    }else if(flag == 0)
                    {
                        sprite15.anchors.bottomMargin = sprite18.anchors.bottomMargin-20;
                        flag = 1;
                    }
                }
            }
        ...
        TexturePackerAnimatedSprite {
            ...
            MouseArea {
                ...
                {
                    if(flag == 1){
                        sprite19.anchors.bottomMargin = sprite19.anchors.bottomMargin+20;
                        flag = 0;
                    }else if(flag == 0)
                    {
                        sprite19.anchors.bottomMargin = sprite19.anchors.bottomMargin-20;
